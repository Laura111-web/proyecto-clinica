...
public class pantallaCiudades extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener, View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pantalla_ciudades);
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem menuitem) {
        ...
        if (itemId == R.id.nav_Principal) {
            Intent intent = new Intent(pantallaCiudades.this, pantallaPrincipal.class);
            startActivity(intent);
            return true;
        }
        if (itemId == R.id.nav_Perfil) {
            Intent intent = new Intent(pantallaCiudades.this, pantallaPerfil.class);
            startActivity(intent);
            return true;
        }
        if (itemId == R.id.nav_Informes) {
            Intent intent = new Intent(pantallaCiudades.this, pantallaInformes.class);
            startActivity(intent);
            return true;
        }
        if (itemId == R.id.nav_Citas) {
            Intent intent = new Intent(pantallaCiudades.this, Citas.class);
            startActivity(intent);
            return true;
        }
        if (itemId == R.id.nav_pedirCitas) {
            Intent intent = new Intent(pantallaCiudades.this, pantallaCiudades.class);
            startActivity(intent);
            return true;
        }
        if (itemId == R.id.nav_servicios) {
            Intent intent = new Intent(pantallaCiudades.this, ServiciosPsiquiatricos.class);
            startActivity(intent);
            return true;
        }
        if (itemId == R.id.nav_contacto) {
            Intent intent = new Intent(pantallaCiudades.this, pantallaContactos.class);
            startActivity(intent);
            return true;
        }
        if (itemId == R.id.nav_acerca) {
            Intent intent = new Intent(pantallaCiudades.this, pantallaAcercaDe.class);
            startActivity(intent);
            return true;
        }
    ...
    private void mostrarAlertaCerrarSesion() {
        ...
        builder.setPositiveButton("Sí", (dialog, which) -> {
            ...
            Intent intent = new Intent(pantallaCiudades.this, inicioSesion.class);
    ...
    public void onClick(View v) {
        ...
        if (v.getId() == R.id.buttonBadajoz) {
            Intent i = new Intent(getApplicationContext(), pantallaPedirCitas.class);
