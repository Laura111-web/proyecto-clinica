...
public class pantallaConfirmarCitasCambiarCita extends AppCompatActivity implements View.OnClickListener, NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pantalla_confirmar_citas_cambiar_cita);
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem menuitem) {
        ...
        if (itemId == R.id.nav_Principal) {
            Intent intent = new Intent(pantallaConfirmarCitasCambiarCita.this, pantallaPrincipal.class);
            startActivity(intent);
            return true;
        }
        if (itemId == R.id.nav_Perfil) {
            Intent intent = new Intent(pantallaConfirmarCitasCambiarCita.this, pantallaPerfil.class);
            startActivity(intent);
            return true;
        }
        if (itemId == R.id.nav_Informes) {
            Intent intent = new Intent(pantallaConfirmarCitasCambiarCita.this, pantallaInformes.class);
            startActivity(intent);
            return true;
        }
        if (itemId == R.id.nav_Citas) {
            Intent intent = new Intent(pantallaConfirmarCitasCambiarCita.this, Citas.class);
            startActivity(intent);
            return true;
        }
        if (itemId == R.id.nav_pedirCitas) {
            Intent intent = new Intent(pantallaConfirmarCitasCambiarCita.this, pantallaCiudades.class);
            startActivity(intent);
            return true;
        }
        if (itemId == R.id.nav_servicios) {
            Intent intent = new Intent(pantallaConfirmarCitasCambiarCita.this, ServiciosPsiquiatricos.class);
            startActivity(intent);
            return true;
        }
        if (itemId == R.id.nav_contacto) {
            Intent intent = new Intent(pantallaConfirmarCitasCambiarCita.this, pantallaContactos.class);
            startActivity(intent);
            return true;
        }
        if (itemId == R.id.nav_acerca) {
            Intent intent = new Intent(pantallaConfirmarCitasCambiarCita.this, pantallaAcercaDe.class);
            startActivity(intent);
            return true;
        }
    ...
    private void mostrarAlertaCerrarSesion() {
        ...
        builder.setPositiveButton("Sí", (dialog, which) -> {
            ...
            Intent intent = new Intent(pantallaConfirmarCitasCambiarCita.this, inicioSesion.class);
    ...
    private void mostrarCita() {
        ...
        Cursor fila = bd.rawQuery("SELECT * FROM citas WHERE usuario=? AND idCita=? ", new String[]{usuario, String.valueOf(idCita)});
        if (fila.moveToFirst()) {
            do {
                ...
                if (destinatario != null && !destinatario.isEmpty()) {
                    ...
                    enviarCorreo(destinatario, "Confirmación de Cita", "Su cita ha sido cambiada.\n\nDatos de la cita:\n " + detallesCita);
                } else {
